                    ...
                    <tr>
                            ...
                            <% for (int day = 0; day < 7; day++) {
                                    ...
                                    for (ScheduleTrainerDTO scheduleTrainerDTO : listScheduleTrainer) {
                                        if (scheduleTrainerDTO.getThu().equalsIgnoreCase(dayOfWeek) && scheduleTrainerDTO.getMaSlot().equals(slot) && scheduleTrainerDTO.getNgayHoc().equals(Date.valueOf(listDate.get(day)))) {
                                            ...
                                            maLopHocTrainer = scheduleTrainerDTO.getMaLopHoc();
                                            tenTrainer = scheduleTrainerDTO.getMaTrainer();
                                            break;
                        ...
                        <td>
                            ...
                            <div class="bg-green" style="text-align: center;">
                                <span class=" padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13"><%=maLopHocTrainer%><br><%=tenTrainer%></span>
                            </div>
