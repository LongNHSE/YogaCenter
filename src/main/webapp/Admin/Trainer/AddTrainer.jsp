...
<html>
    <head>
        ...
        <link href="../Class/image.css" rel="stylesheet" type="text/css"/>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="" name="description">
        <link href="../Class/newCascadeStyleSheet.css" rel="stylesheet" type="text/css"/>
                    ...
                    <ul>
                        ...
                        <li id="active" class='sub-menu'><a href='#message'>Trainer<div class='fa fa-caret-down right'></div></a>
                            <ul id="active">
                                ...
                                <li id="active-element"><a href='<%=url%>/Admin/Trainer/AddTrainer.jsp'>Add Trainer</a></li>
                                <li><a href='#settings'>Network Status</a></li>
                            </ul>
                        </li>
