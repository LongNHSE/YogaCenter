...
<html>
    <head>
        ...
        <link href="<%=url%>/css/OTP.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
      <div class="login-dark">
          <form action="<%=url%>/LoginController/signup" method="POST">
              ...
              <div class="form-group">
                    ...
                    <input type="hidden" id="thisField" name="action" value="OTPVerify">                    
              </div>
              <div>
                              <c:if test="${not empty errorMsg}">
                                    <div class="text-danger bo" role="alert"> 
                                          <p class="error"> <strong>${errorMsg}</strong> 
                                          <a href ="<%=url%>/Authentication/signin.jsp">Return to login page.</a> 
                                          </p>
                                    </div>                                      
                              </c:if>                         
              </div>
