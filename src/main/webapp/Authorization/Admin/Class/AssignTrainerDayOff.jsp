                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <div class="form-outline">
                                                ...
                                                <select name="listTrainer"   class="selected-control "  required>
                                                    ...
                                                    <c:forEach items="${listTrainer}" var="Trainer">
                                                        <option class="form-label" value="${Trainer.maTrainer}">${Trainer.maTrainer} - ${Trainer.ho} ${Trainer.ten}</option>
                                                    </c:forEach>
                                                </select>
                                                </br>
                                            ...
                                            <div class="mb-1">
                                                <div class="mt-4 pt-2">
                                                    ...
                                                    <input type="hidden" name="maApplication" value="${maApplication}" />
                                                    <input type="hidden" name="maLopHoc" value="${maLopHoc}" />
                                                    <input type="hidden" name="action" value="AssignTrainerDayOff" />
