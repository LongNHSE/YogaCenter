...
<html>
    ...
    <body>
        ...
        <div class="container py-5 h-100">
            <form action="<%=url%>/VoucherController?action=addVoucher" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="voucherName" class="form-control form-control-lg" name="username" required="required"/>
                                            <label class="form-label" for="userName">Voucher Name</label>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <div class="input-container">
                                                <input type="number" id="globalUsageLimit" class="form-control form-control-lg" name="globalUsageLimit" />
                                                <label class="form-label" for="globalUsageLimit">Total Usage</label>
                                            </div>
                                        </div>                            
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <div class="input-container">
                                                <input type="number" id="individualUsage" class="form-control form-control-lg" name="individualUsage" />
                                                <label class="form-label" for="individualUsage">Individual Usage</label>
                                            </div>
                                        </div>                            
                                    </div>
                                    <div class="mt-4 pt-2">
                                        <button class="btn btn-outline-danger" name="action" value="addVoucher" id="submit" type="submit"  >Submit</button>
                                    </div
